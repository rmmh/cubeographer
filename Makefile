...
dist/textures/atlas.png:
	montage textures/faithful/assets/minecraft/textures/block/*.png -background none -geometry 32x32+0+0 -crop 32x32+0+0 -tile 32x32 dist/textures/atlas.png
